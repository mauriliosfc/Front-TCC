      ...
      <v-timeline>
        <v-timeline-item v-for="n in 1" :key="n" large>
          ...
          <template v-slot:opposite>
            <span>ICPIC - SUIÇA 2019</span>
          </template>
          <v-card class="elevation-2">
            <v-card-title class="headline">1º Artigo publicado</v-card-title>
        ...
        <v-timeline-item v-for="n in 1" :key="n" large>
          ...
          <v-card class="elevation-2">
            <v-card-title class="headline">2º Artigo publicado</v-card-title>
        ...
        <v-timeline-item v-for="n in 1" :key="n" large>
          ...
          <v-card class="elevation-2">
            <v-card-title class="headline">3º Artigo publicado</v-card-title>
        ...
        <v-timeline-item v-for="n in 1" :key="n" large>
          ...
          <v-card class="elevation-2">
            <v-card-title class="headline">4º Artigo publicado</v-card-title>
        ...
        <v-timeline-item v-for="n in 1" :key="n" large>
          ...
          <v-card class="elevation-2">
            <v-card-title class="headline">5º Artigo publicado</v-card-title>
        ...
        <v-timeline-item v-for="n in 1" :key="n" large>
          ...
          <v-card class="elevation-2">
            <v-card-title class="headline">6º Artigo publicado</v-card-title>
        ...
        <v-timeline-item v-for="n in 1" :key="n" large>
          ...
          <v-card class="elevation-2">
            <v-card-title class="headline">7º Artigo publicado</v-card-title>
        ...
        <v-timeline-item v-for="n in 1" :key="n" large>
          ...
          <v-card class="elevation-2">
            <v-card-title class="headline">8º Artigo publicado</v-card-title>
        ...
        <v-timeline-item v-for="n in 1" :key="n" large>
          ...
          <v-card class="elevation-2">
            <v-card-title class="headline">9º Artigo publicado</v-card-title>
        ...
        <v-timeline-item v-for="n in 1" :key="n" large>
          ...
          <v-card class="elevation-2">
            <v-card-title class="headline">10º Artigo publicado</v-card-title>
        ...
        <v-timeline-item v-for="n in 1" :key="n" large>
          ...
          <v-card class="elevation-2">
            <v-card-title class="headline">11º Artigo publicado</v-card-title>
        ...
        <v-timeline-item v-for="n in 1" :key="n" large>
          ...
          <v-card class="elevation-2">
            <v-card-title class="headline">12º Artigo publicado</v-card-title>
        ...
        <v-timeline-item v-for="n in 1" :key="n" large>
          ...
          <v-card class="elevation-2">
            <v-card-title class="headline">13º Artigo publicado</v-card-title>
        ...
        <v-timeline-item v-for="n in 1" :key="n" large>
          ...
          <v-card class="elevation-2">
            <v-card-title class="headline">14º Artigo publicado</v-card-title>
        ...
        <v-timeline-item v-for="n in 1" :key="n" large>
          ...
          <v-card class="elevation-2">
            <v-card-title class="headline">15º Artigo publicado</v-card-title>
        ...
        <v-timeline-item v-for="n in 1" :key="n" large>
          ...
          <v-card class="elevation-2">
            <v-card-title class="headline">16º Artigo publicado</v-card-title>
        ...
        <v-timeline-item v-for="n in 1" :key="n" large>
          ...
          <v-card class="elevation-2">
            <v-card-title class="headline">17º Artigo publicado</v-card-title>
