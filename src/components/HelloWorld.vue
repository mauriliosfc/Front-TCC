<template>
  ...
  <b-card sm-5 bg-variant="light">
    ...
    >
      <b-form-group        
        label="tipo_cuirurgia_especifica:"        
      >
      ...
      >
        <b-form-input v-model="form.hospital" id="nested-country" type='number'></b-form-input>
      </b-form-group> -->
